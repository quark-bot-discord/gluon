...
function bundleChannel(channel) {
  ...
  if (channel.bitrate) data.bitrate = channel.bitrate;
  if (channel.user_limit) data.user_limit = channel.user_limit;
  if (channel.rtc_region) data.rtc_region = channel.rtc_region;
  return data;
}
