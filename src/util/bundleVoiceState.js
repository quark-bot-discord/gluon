...
function bundleVoiceState(voiceState) {
  const data = {};
  data.guild_id = voiceState.guild
    ? voiceState.guild.id.toString()
    : voiceState.guild_id.toString();
  data.channel_id = voiceState.channel
    ? voiceState.channel.id.toString()
    : voiceState.channel_id.toString();
  ...
  data.user_id = voiceState.user
    ? voiceState.user.id.toString()
    : voiceState.user_id.toString();
