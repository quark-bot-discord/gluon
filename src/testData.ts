...
const SLASH_COMMAND: APIChatInputApplicationCommandGuildInteraction = {
...
const INTERACTION: APIGuildInteraction = {
  id: "123451189012345678",
  type: InteractionType.ApplicationCommand,
  data: {
    name: "test",
...
const INVITE: APIExtendedInvite = {
  code: "test",
  channel: {
    id: "123456789112345678",
    name: "test-channel",
...
const SCHEDULED_EVENT: APIGuildScheduledEvent = {
...
const SCHEDULED_EVENT_EXTERNAL: APIGuildScheduledEvent = {
  id: "123409989012345678",
  guild_id: "619434557472505857",
  channel_id: null,
  creator_id: "301655085954367490",
...
const CLIENT_MEMBER_ADMIN: APIGuildMember = {
  user: {
    id: "704802632660943089",
    username: "quark",
    discriminator: "0001",
...
const CLIENT_MEMBER: APIGuildMember = {
  user: {
    id: "704802632660943089",
    username: "quark",
    discriminator: "0001",
...
const TEXT_CHANNEL_2: APIGuildTextChannel<ChannelType.GuildText> = {
