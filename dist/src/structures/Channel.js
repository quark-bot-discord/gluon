...
var _Channel__client,
  _Channel__id,
  _Channel__guild_id,
  _Channel_type,
  _Channel_name,
  _Channel_topic,
  _Channel_permission_overwrites,
  _Channel_rate_limit_per_user,
  _Channel__parent_id,
  _Channel__attributes,
  _Channel__cacheOptions,
  _Channel_messages,
  _Channel_position;
import {
...
class Channel {
  ...
  constructor(client, data, { guildId } = {}) {
    _Channel__client.set(this, void 0);
    _Channel__id.set(this, void 0);
    _Channel__guild_id.set(this, void 0);
    _Channel_type.set(this, void 0);
    _Channel_name.set(this, void 0);
    _Channel_topic.set(this, void 0);
    _Channel_permission_overwrites.set(this, void 0);
    _Channel_rate_limit_per_user.set(this, void 0);
    _Channel__parent_id.set(this, void 0);
    _Channel__attributes.set(this, void 0);
     ...
     * @private
     */
    __classPrivateFieldSet(this, _Channel__client, client, "f");
    /**
     * The id of the channel.
     * @type {BigInt}
     * @private
     */
    __classPrivateFieldSet(this, _Channel__id, BigInt(data.id), "f");
    /**
     * The ID of the guild that this channel belongs to.
     * @type {BigInt}
     * @private
     */
    __classPrivateFieldSet(this, _Channel__guild_id, BigInt(guildId), "f");
    /**
     * The type of channel.
     * @type {Number}
     * @private
     */
    __classPrivateFieldSet(this, _Channel_type, data.type, "f");
    ...
    if (typeof data.name == "string")
      __classPrivateFieldSet(this, _Channel_name, data.name, "f");
    else if (
      typeof data.name != "string" &&
      existing &&
      typeof existing.name == "string"
    )
      __classPrivateFieldSet(this, _Channel_name, existing.name, "f");
    /**
    ...
    if (typeof data.topic == "string")
      __classPrivateFieldSet(this, _Channel_topic, data.topic, "f");
    else if (
      typeof data.topic != "string" &&
      existing &&
      typeof existing.topic == "string"
    )
      __classPrivateFieldSet(this, _Channel_topic, existing.topic, "f");
    /**
        ...
        data.permission_overwrites.map(
          (p) =>
            new PermissionOverwrite(
              __classPrivateFieldGet(this, _Channel__client, "f"),
              p,
            ),
        ),
        "f",
    ...
    if (typeof data.position == "number") {
      __classPrivateFieldSet(this, _Channel_position, data.position, "f");
    } else if (
      typeof data.position != "number" &&
      existing &&
      typeof existing.position == "number"
    ) {
      __classPrivateFieldSet(this, _Channel_position, existing.position, "f");
    }
    if (typeof data.parent_id == "string") {
      ...
      __classPrivateFieldSet(this, _Channel__parent_id, existing.parentId, "f");
    /**
    ...
    if (data.nsfw !== undefined && data.nsfw == true)
      __classPrivateFieldSet(
        this,
        _Channel__attributes,
        __classPrivateFieldGet(this, _Channel__attributes, "f") | (0b1 << 0),
        "f",
      );
  ...
  get guild() {
    return (
      __classPrivateFieldGet(this, _Channel__client, "f").guilds.get(
        this.guildId,
      ) || null
    );
  }
   ...
   */
  get id() {
    return String(__classPrivateFieldGet(this, _Channel__id, "f"));
  }
  /**
   * The ID of the guild that this channel belongs to.
   * @type {String}
   ...
   */
  get guildId() {
    return String(__classPrivateFieldGet(this, _Channel__guild_id, "f"));
  }
  /**
   * The ID of the parent channel.
   * @type {String?}
   ...
   */
  get parentId() {
    return __classPrivateFieldGet(this, _Channel__parent_id, "f")
      ? String(__classPrivateFieldGet(this, _Channel__parent_id, "f"))
      : null;
  }
  /**
   * The type of channel.
   ...
   */
  get type() {
    return __classPrivateFieldGet(this, _Channel_type, "f");
  }
  /**
   * The name of the channel.
   * @type {String?}
   ...
   */
  get topic() {
    return __classPrivateFieldGet(this, _Channel_topic, "f");
  }
  /**
   * The permission overwrites for this channel.
   * @type {Array<Object>}
  ...
  get permissionOverwrites() {
    return __classPrivateFieldGet(this, _Channel_permission_overwrites, "f");
  }
  /**
   * The message send cooldown for the channel.
   * @type {Number?}
  ...
  get rateLimitPerUser() {
    return __classPrivateFieldGet(this, _Channel_rate_limit_per_user, "f");
  }
  /**
   * The position of the channel.
   * @type {Number?}
   ...
   */
  get position() {
    return __classPrivateFieldGet(this, _Channel_position, "f");
  }
  /**
   * The cache options for this channel.
   * @type {ChannelCacheOptions}
   ...
   */
  get _cacheOptions() {
    return __classPrivateFieldGet(this, _Channel__cacheOptions, "f");
  }
  /**
   ...
   */
  get messages() {
    return __classPrivateFieldGet(this, _Channel_messages, "f");
  }
  /**
   ...
   * @public
   */
  [((_Channel__client = new WeakMap()),
  (_Channel__id = new WeakMap()),
  (_Channel__guild_id = new WeakMap()),
  (_Channel_type = new WeakMap()),
  (_Channel_name = new WeakMap()),
  (_Channel_topic = new WeakMap()),
  (_Channel_permission_overwrites = new WeakMap()),
  (_Channel_rate_limit_per_user = new WeakMap()),
  (_Channel__parent_id = new WeakMap()),
  (_Channel__attributes = new WeakMap()),
  (_Channel__cacheOptions = new WeakMap()),
  (_Channel_messages = new WeakMap()),
  (_Channel_position = new WeakMap()),
  util.inspect.custom)]() {
    ...
    switch (format) {
      ...
      case TO_JSON_TYPES_ENUM.CACHE_FORMAT: {
        return {
          ...
          _attributes: __classPrivateFieldGet(this, _Channel__attributes, "f"),
