...
import GluonCacheOptions from "../GluonCacheOptions.js";
  ...
  context("check toString", function () {
    it("should return the correct string", function () {
      ...
      expect(cacheOptionsString).to.equal(
        "GluonCacheOptions { GUILDS: true, USERS: true, CHANNELS: true, MESSAGES: true, ROLES: true, EMOJIS: true, INVITES: true, VOICESTATES: true, MEMBERS: true, SCHEDULEDEVENTS: true, AUDITLOGS: true, USER_TTL: 30, MESSAGE_TTL: 30 }",
      );
    });
  });
});
//# sourceMappingURL=GluonCacheOptions.spec.js.map
